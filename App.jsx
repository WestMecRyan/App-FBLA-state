...
import { View, Text, TouchableOpacity, Animated, Dimensions, Easing, StyleSheet, StatusBar, Platform, Image, ScrollView, UIManager, ImageBackground } from "react-native";
      ...
      <View style={styles.loadingBackgroundContainer}>
        ...
        <View style={styles.loadingOverlay}>
          <View style={styles.loadingContainer}>
            ...
            <Text style={[
              styles.loadingText,
              fontsLoaded ? { fontFamily: "pixel-font" } : { fontWeight: "bold" }
            ]}>
              {loadingStatus}
            </Text>
            ...
            <View style={styles.progressBarContainer}>
              <View
                style={[
                  ...
                  { width: `${(currentLoadingItem / totalLoadingItems) * 100}%` }
                ]}
              />
            </View>
            ...
            <Text style={[
              styles.tipText,
              fontsLoaded ? { fontFamily: "pixel-font" } : null
            ]}>
